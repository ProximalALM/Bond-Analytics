...
ts0 = term_structure(bond_data, bond_info, bond_calendar, 7, 11, 2018, day_count, convention, 'Piecewise Log Cubin Discount')
...
plt.title('Yield Curve by Piecewise Log Cubic Discount')
plt.legend(loc = 0)
plt.show()
